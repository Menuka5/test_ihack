...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
            ...
            <div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>iHack</span>Admin</a>
			</div>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class=""><a href="adminpanel.html"><span class="glyphicon glyphicon-dashboard"></span> My Profile</a></li>
            <li class="parent active">
				...
				<ul class="children collapse" id="sub-item-1">
					<li>
						<a class="active" href="addmoderate.jsp">
							<font color="white" ><span class="glyphicon glyphicon-share-alt"></span>  Add Moderator</font>
						</a>
					</li>
					<li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="addmoderate.jsp"><span class="glyphicon glyphicon-home"></span></a></li>
				<li class="active">Add Moderator</li>
			</ol>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Add Moderator</h2>
            <center>
            <table class="table">
            <tr>
