<%-- 
    Document   : showgroup
    Created on : Sep 6, 2015, 6:33:22 AM
    Author     : janaka
--%>
...
<body>
		...
		<ul class="nav menu">
			...
			<li class="parent active">
				...
				<ul class="children collapse" id="sub-item-2">
					<li>
						<a class="active" href="showgroup.jsp">
							<font color="white" ><span class="glyphicon glyphicon-share-alt"></span> Show Groups
						</a></font>
					</li>
					<li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="showgroup.jsp"><span class="glyphicon glyphicon-home"></span></a></li>
				<li class="active">Show Groups</li>
			</ol>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Show Groups</h2>
