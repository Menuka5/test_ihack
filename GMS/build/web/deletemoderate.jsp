<%-- 
    Document   : removemoderate
    Created on : Sep 6, 2015, 6:35:28 AM
    Author     : janaka
--%>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
            ...
            <div class="navbar-header">
				...
				<a class="navbar-brand" href="adminpanel"><span>iHack</span>Admin</a>
			</div>
		...
		<ul class="nav menu">
            ...
            <li class="parent active">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li>
						<a class="" href="deletemoderate.jsp">
							<span class="glyphicon glyphicon-share-alt"></span> Remove Moderator
						</a>
					</li>
					<li>
						<a class="active" href="showmoderate.jsp">
							<font color="white" ><span class="glyphicon glyphicon-share-alt"></span> Show Moderator
						</a></font>
					</li>
				</ul>
			</li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="deletemoderate.jsp"><span class="glyphicon glyphicon-home"></span></a></li>
				<li class="active">Remove Moderators</li>
			</ol>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Remove Moderators</h2>
            <center>
            <table class="table">
            <tr>
